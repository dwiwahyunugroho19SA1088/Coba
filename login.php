...
if (isset($_POST['login'])) {
    ...
    // cocokan data dengan database, ada atau tidak datanya
                                ...
                                <div class="card-body">
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-4" name="password" id="password" type="text" placeholder="Masukan Password" required />
                                        </div>
